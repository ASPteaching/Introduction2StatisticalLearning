...
## The Neural Network Model {.smaller}

-   An Artificial Neural Network (ANN) is a computational model that mimics the structure and function of the human brain.
...
- Commonly used in multiclass classification tasks to convert raw scores into probabilities. 

- Inputs a vector of real numbers and normalizes it into a probability distribution over multiple classes. 

- Outputs a vector where each element represents the probability of the corresponding class.
