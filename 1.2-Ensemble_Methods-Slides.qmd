...
::: {.column width='50%'}
```{r, out.width="100%", fig.align='center', fig.cap="VIP for trees computed with `caret`. Values are standardized -> most important feature has a value of 100"}
knitr::include_graphics("images/ames1VIP.png")
```
:::
...
```{r, out.width="100%", fig.cap="Random Forests Algorithm, from chapter 17 in [@Hastie2016]. This version of the algorithm includes computin OOBE, but, strictly speaking it is another algorithm"}
